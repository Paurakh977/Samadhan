...
class SignupWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        ui_file_location = os.path.abspath(
            os.path.join(this_file_location, "..", "UI", "signup.ui")
        )
    ...
    def setupUI(self):
        ...
        # finding child
        self.already_have_an_account = self.findChild(
            QtWidgets.QPushButton, "signup_btn"
        )
        ...
        self.ph_nmbr_line_edit = self.findChild(
            QtWidgets.QLineEdit, "ph_nmbr_line_edit"
        )
    ...
    def signup_manual(self):
        ...
        if name and ph_nmbr and email and password and radio:
            ...
            response = insert_manual_users(
                name, email, ph_nmbr, hashed_password, serial_id, radio
            )
            if not response:
                show_message_box(
            ...
            show_message_box(
                "Please Fill Every Feild to Proceed",
                "Incomplete Form",
    ...
    def signup_with_google(self):
        ...
        try:
            ...
            if status:
                ...
                show_message_box(
                    "There is already an account associated with the chosen google account\nPlease Try Again using another Google Account",
                    "User Already Exists",
                    QtWidgets.QMessageBox.Information,
                )
        except Exception as e:
