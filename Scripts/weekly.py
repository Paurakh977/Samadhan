...
class WeeklyWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def setup_UI(self):
        ...
        self.frame_1.setStyleSheet("QFrame { background-color: #e9f0ea; border: 4px solid #000; }")
        
        self.label1 = QtWidgets.QLabel(self.frame_1)
        self.label1.setText("THIS IS WEEKLY PAGE")
